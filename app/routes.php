...
Route::get('mail',function(){
	...
	Mail::send('admin.mails.message',['msg'=>"test"],function ($message)  {
      $message->subject('d')
      		  ->from('consultants@akdn.org')
              ->to('maulika@thinktanker.in');
    });
	echo "Sent";
});
...
Route::group(array('before' => ['csrf','ip_blacklisted'] ), function() {
	...
	// Route::get('/verifyregister/{token}',array(
	// 	'as' => 'verifyregister',
	// 	'uses' => 'ConsultantSponsorController@verify'
	// 	));
	// Route::get('/register',array(
	// 	'as' => 'user.registers',
	// 	'uses' => function(){
	// 		return View::make('register_error');}
	// 	));
	// Route::get('/register/{token}', array(
	// 		'as'	=> 'user.register',
	// 		'uses'  => 'ConsultantController@register'
	// 	));
	...
	Route::group(array('prefix' => 'akdn'), function(){
		...
		*/
		...
		Route::group(array('before' => 'auth.akdn', 'after' => 'akdn_last_activity'), function(){
			...
			Route::get('/consultant/profile/downloadPdf/{id}', array(
				'as'=> 'akdn.constant.downloadpdf',
				'uses'=>'AkdnConsultantController@downloadPdf'
			));

			Route::post('/consultant/profile/preview', array(
				'as'=> 'akdn.constant.preview',
				'uses'=>'AkdnConsultantController@preview'
			));
	...
	Route::group(array('prefix' => 'admin'), function()
	{
		...
		Route::group(array('before' => 'auth.admin'), function(){
			...
			Route::group(array('before'=>'acl.permited'),function(){
				Route::get('/user/excelexport', array(
					'as'=> 'admin.user.excelexport',
					'uses'=>'AdminConsultantController@excelExport'
				));
				...
				Route::get('/akdn/excelexport', array(
					'as'=> 'admin.akdn.excelexport',
					'uses'=>'AdminAkdnController@excelExport'
				));
				Route::resource('akdn','AdminAkdnController');

				Route::get('/role/excelexport', array(
					'as'=> 'admin.role.excelexport',
					'uses'=>'AdminRoleController@excelExport'
				));
				...
				Route::get('/specialization/excelexport', array(
					'as'=> 'admin.specialization.excelexport',
					'uses'=>'AdminSpecializationController@excelExport'
				));
				...
				Route::get('/adminuser/excelexport', array(
					'as'=> 'admin.adminuser.excelexport',
					'uses'=>'AdminUserController@excelExport'
				));
				...
				Route::get('/awarded/excelexport', array(
					'as'=> 'admin.awarded.excelexport',
					'uses'=>'AdminAwardedConsultancyController@excelExport'
				));
				...
				Route::get('/language/excelexport', array(
					'as'=> 'admin.language.excelexport',
					'uses'=>'AdminLanguageController@excelExport'
				));
				...
				Route::get('/skill/excelexport', array(
					'as'=> 'admin.skill.excelexport',
					'uses'=>'AdminSkillController@excelExport'
				));
				...
				Route::get('/firewall/excelexport', array(
					'as'=> 'admin.firewall.excelexport',
					'uses'=>'FirewallController@excelExport'
				));
				Route::get('firewall',[
				...
				Route::get('/loginlogs/admin/excelexport', array(
					'as'=> 'admin.loginlogs.excelexport',
					'uses'=>'LoginLogsController@excelExport'
				));
				...
				Route::get('/agencies/excelexport', array(
					'as'=> 'admin.agencies.excelexport',
					'uses'=>'AdminAgenciesController@excelExport'
				));
				...
				Route::get('/constantsponsor/{id}/edit', array(
					'as'=> 'admin.constantsponsor.edit',
					'uses'=>'AdminConsultantSponserController@edit'
				));

				Route::post('/constantsponsor/{id}', array(
					'as'	=> 'admin.constantsponsor.update',
					'uses'	=> 'AdminConsultantSponserController@update' 
				));

				Route::get('/constantsponsor/excelexport', array(
					'as'=> 'admin.constantsponsor.excelexport',
					'uses'=>'AdminConsultantSponserController@excelExport'
				));
