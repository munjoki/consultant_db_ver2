...
class Consultant extends Eloquent implements UserInterface, RemindableInterface {
	...
	protected $fillable = array('surname','other_names','address','city','gender','consultant_type','company_name','telno','skypeid','email','alternate_email','pub_profile','resume', 'linkedin_url','website_url');
	...
	public static $rules = array(
		...
		//'skypeid'				=> 'numeric|regex:/[0-9]{8,15}/',
