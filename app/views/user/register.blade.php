						...
						<div class="col-md-12">
							{{Form::open(array('route'=>'register.post','method'=>'post','id'=>'register_form','files' => true, 'class' => 'form-horizontal')); }}
								<fieldset>
									...
									<label><h5>
											You have been sponsored by an Aga Khan Development Network (AKDN) staff member to register with our Monitoring, Evaluation and Research (MER) Consultant Database. 
											This database is maintained by the AKDN Quality of Life MER Support Unit. 
											The purpose of this database is to provide AKDN staff members with a pool of qualified MER consultants who are interested in being considered for consulting opportunities with AKDN agencies. 
								...
								<fieldset>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="col-md-4 control-label" for="surname">Surname <span class="text-danger">*</span></label>
												<div class="col-md-8">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="col-md-4 control-label" for="other_names">First/Given Name(s) <span class="text-danger">*</span></label>
												<div class="col-md-8">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="col-md-4 control-label" for="consultant type">Consultant Type <span class="text-danger">*</span></label>
												<div class="col-md-8">
													{{ Form::select('consultant_type', array( '' => 'Select consultant type' ,'Independent consultant' => 'Independent consultant', 'Institution-affiliated' => 'Institution-affiliated','both' => 'Both independent and institution-affiliated'), Input::old('consultant_type'), array('class' => 'form-control','id' => 'consultant_type','onChange'=>'changetextbox();')) }}
								...
								<fieldset>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<!-- <div class="form-group">
												<label class="col-md-4 control-label" for="alternate_telno">Alternative Tel. (inc. country code) </label>
												<div class="col-md-8">
													<div class="input-group">
														<div class="input-group-addon">
															<i class="fa fa-plus"></i>
											...
											<div class="form-group">
												<label class="col-md-4 control-label" for="skypeid">Skype ID</label>
												<div class="col-md-8">
												...
												<div class="col-md-12">
													<table class="table table-bordered table-responsive">
														<thead>
															...
															<tr id="language_row">
																<td>{{ Form::select('language',array(""=>"Select Language") + $language , '0', array('class'=>'form-control', 'id' => 'language'))}}</td>
																<td>{{ Form::select('speaking_level', array(""=>"Select Level") + Config::get('language-level'), null, array('class'=>'form-control', 'id' => 'speaking_level'))}}</td>
																<td>{{ Form::select('reading_level', array(""=>"Select Level") + Config::get('language-level'), null, array('class'=>'form-control', 'id' => 'reading_level'))}}</td>
																<td>{{ Form::select('writing_level', array(""=>"Select Level") + Config::get('language-level'), null, array('class'=>'form-control', 'id' => 'writing_level'))}}</td>
																<td>{{ Form::select('understanding_level', array(""=>"Select Level") + Config::get('language-level'), null, array('class'=>'form-control', 'id' => 'understanding_level'))}}</td>
																<td>
