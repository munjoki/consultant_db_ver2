<!------------------------------------------------------------------------------------------------------------------------------------------
	...
	this file handles the end-date to allow for an automatic email to be sent to the manager for review
-------------------------------------------------------------------------------------------------------------------------------------------->
<!DOCTYPE html>
<html>
  <head>
				...
				<div class="register-box-body">
					<div class="row">
						<div class="col-md-12 text-center">
							<strong>Your have successfully extended the consultancy end date. Thank You!</strong>
						</div>
					</div>
				</div>
			</div>
