<!------------------------------------------------------------------------------------------------------------------------------------------
	...
	this file handles the generation of token in case there are errors when giving consultant review
-------------------------------------------------------------------------------------------------------------------------------------------->
<!DOCTYPE html>
<html>
  <head>
	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<div class="alert alert-danger alert-dismissable">
			    ...
			    <b>ERROR!</b> There is something wrong!
			</div>
			<div class="box no-border">
				<div class="register-box-body">
					<div class="row">
						<div class="col-md-12 text-center">
							<strong>Invalid token or review already added.</strong>
						</div>
					</div>
				</div>
			</div>
