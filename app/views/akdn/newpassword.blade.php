<!------------------------------------------------------------------------------------------------------------------------------------------
	...
	this file allows AKDN users to update their profile with a new password after registration
-------------------------------------------------------------------------------------------------------------------------------------------->
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
    <title>Consultant DB | Change Password</title>
  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        {{Form::open(array('route'=>'akdn.newpassword.post','method'=>'post','id'=>'password_form'))}}
