<!------------------------------------------------------------------------------------------------------------------------------------------
	...
	this file allows AKDN users to send a reset password email from their own profile
-------------------------------------------------------------------------------------------------------------------------------------------->
<!DOCTYPE html>
<html>
  <head>
   ...
   {{ HTML::script('assets/plugins/jQuery/jQuery-2.1.3.min.js') }}
    ...
    <script>
      $(function () {
        ...
        @if( Session::has('message') && 'success' == Session::get('message_type'))
          setTimeout(function(){
           window.location = "{{ route('akdn.login') }}"},5000
         );
        @endif
      });
    </script>
