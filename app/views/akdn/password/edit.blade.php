...
<!------------------------------------------------------------------------------------------------------------------------------------------
	...
	this file AKDN staff to change their password from their profile
-------------------------------------------------------------------------------------------------------------------------------------------->
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label class="col-md-4 control-label" for="">Old Password <span class="help-inline">*</span></label>
									<div class="col-md-8">
										{{ Form::password('old_password', array('id' => 'old_password', 'class' => 'form-control', 'placeholder' => 'Enter the old password')) }}
										{{ $errors->first('old_password', '<span class="help-inline">:message</span>')}}
									</div>
								</div>
							
								<div class="form-group">
									<label class="col-md-4 control-label" for="">New password <span class="help-inline">*</span></label>
									<div class="col-md-8">
								...
								<div class="form-group">
									<label class="col-md-4 control-label" for="">Confirm Password <span class="help-inline">*</span></label>
									<div class="col-md-8">
