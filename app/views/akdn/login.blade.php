<!------------------------------------------------------------------------------------------------------------------------------------------
	...
	this file handles AKDN staff login to the database
-------------------------------------------------------------------------------------------------------------------------------------------->
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
    <title>Consultant DB | Log in</title>
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href=""><b>AKDN </b> | Login</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        {{Form::open(array('route'=>'akdn.login.post','method'=>'post','id'=>'login_form'))}}
        ...
        <a href="{{ URL::to('/akdn/password/remind') }}">I forgot my password</a><br>
