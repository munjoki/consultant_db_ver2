...
<!------------------------------------------------------------------------------------------------------------------------------------------
    ...
    this file handles editing existing user role
-------------------------------------------------------------------------------------------------------------------------------------------->
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        {{Form::open(array('route'=>array('admin.role.update',$role_name->id),'method'=>'post','id'=>'akdn_form','files' => true ,'class'=>'form-horizontal')); }}
                        <div class="box-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        {{ Form::text('role_name', Input::old('role_name',$role_name->name), array('id' => 'role_name', 'class' => 'form-control ', 'placeholder' => 'Enter Role Name')) }}
                                    ...
                                    <div class="box box-primary box-solid">
                                        ...
                                        <div class="box-body">
                                              @foreach($consultperm as $value)
                                                <div class="form-group">
                                                    <div class="col-xs-2">
                                                        <input type="checkbox" value="{{$value->id}}" id="permission_{{$value->id}}" name="permission[{{$value->id}}]" <?= (isset($selected[$value->id]) ? 'checked="checked"' : '' ) ?> />
                                                    </div>
                                    ...
                                    <div class="box box-primary box-solid">
                                        ...
                                        <div class="box-body">
                                              @foreach($skillperm as $value)
                                                <div class="form-group">
                                                    <div class="col-xs-2">
                                                        <input type="checkbox" value="{{$value->id}}value->id}}" id="permission_{{$value->id}}" name="permission[{{$value->id}}]" <?= (isset($selected[$value->id]) ? 'checked="checked"' : '' ) ?> />
                                                    </div>
                                                    <label class="col-xs-4">{{$value->description}}</label>
                                                </div>
                                              @endforeach
                            ...
                            <div class="col-md-12"> 
                                <div class="form-group">  
                                    <div class="col-md-6 text-right">
                                        <button type="submit" id="frm-submit" class="btn btn-primary">Edit Role </button> 
                                    </div>
