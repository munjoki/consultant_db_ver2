	...
	<div class="col-md-12">
		...
		<div class="box box-primary box-solid">
			...
			<div class="box-header with-border">
				...
				<div class="box-tools pull-right">
                <a href="{{ URL::route('admin.constant.show',array(Request::segment(4))) }}" class="btn btn-box-tool"><b>Back</b></a>
				</div>
			</div>
			<div class="box-body">
...
@section('script')
	...
	jQuery(document).ready(function() {
        ...
        dt_previous_consultancies = $('#dt_previous_consultancies').dataTable({
            ...
            "bProcessing" : false,
            "bServerSide" : true,
            "sAjaxSource" : "{{ URL::route('admin.showPreviousConsultancies',array(Request::segment(4))) }}",
            "aaSorting"   : [[1, "desc"]],
            "aoColumns"   : [
                {
                    mData     : "id",
