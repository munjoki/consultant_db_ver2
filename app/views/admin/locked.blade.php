...
<html>
  ...
  <body class="hold-transition lockscreen">
    ...
    <div class="lockscreen-wrapper">
      ...
      <!-- User name -->
      <div class="lockscreen-name">{{ Session::get('admin')['username'] }}</div>
      ...
      <div class="lockscreen-item">
        ...
        <form class="lockscreen-credentials" method="POST" action="{{ route('admin.login.post') }}">
          {{ Form::token(); }}
          <input type="hidden" name="email" class="form-control" value="{{ Session::get('admin')['email'] }}" >
