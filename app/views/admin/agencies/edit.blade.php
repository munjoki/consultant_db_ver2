		...
		<div class="row">
			...
			<div class="box box-primary">
					<div class="box-header">
						{{Form::open(array('route'=>array('admin.agencies.update',$agencies->id),'method'=>'post','files' => true ,'class'=>'form-horizontal')); }}
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-xs-6">
											{{ Form::text('acronym', Input::old('acronym',$agencies->acronym), array('id' => 'acronym', 'class' => 'form-control ', 'placeholder' => 'Acronym of Agency')) }}
									...
									<div class="form-group">
										...
										<div class="col-xs-6">
											{{ Form::text('fullname', Input::old('fullname',$agencies->fullname), array('id' => 'acronym', 'class' => 'form-control ', 'placeholder' => 'Full Name of Agency')) }}
								...
								<div class="col-md-8 col-md-offset-4"> 
									<button type="submit" id="frm-submit" class="btn btn-primary">Update Agency</button> 
