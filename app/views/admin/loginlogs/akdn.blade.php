        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="<?= route('admin.loginlogs.user') ?>">Consultant Logins</a></li>
                    @endif
                    <li class="active"><a href="javascript:void(0)">AKDN User Logins</a></li>
                    ...
                    <div class="tab-pane active">
                        <div class="box box-primary box-solid">
                            <div class="box-header with-border">
                                <h3 class="box-title">AKDN User Login Logs</h3>
...
$(function() {
    ...
    login_logs = $('#login_logs').dataTable({
        ...
        "autoWidth": true,
        "bStateSave": true,
        "sAjaxSource": "{{URL::route('admin.loginlogs.akdn')}}",
        "oLanguage": {
        ...
        "fnServerParams": function ( aoData ) {
            ...
            aoData.push({ "name": "user_type", "value": "akdn"});
